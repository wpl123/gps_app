...
def write_kml(waypts):
    ...
    for prev_waypt in waypts:
        ...
        #if int(waypt[0] + 4) % 4 == 0:    # start point
        linecoords = [(prev_waypt[2], prev_waypt[3]), (waypt[2], waypt[3])]
        #elif int(waypt[0] + 4) % 4 == 1:    # end of strip
        linecoords = [(waypt[2], waypt[3]), (next_waypt[2], next_waypt[3])]
        #elif int(waypt[0] + 4) % 4 == 2:    # start of next strip
                
        #else:
        #    linecoords = [(waypt[2], waypt[3]), (next_waypt[2], next_waypt[3])]
        #    linecoords = [(waypt[2], waypt[3]), (next_waypt[2], next_waypt[3])]    
        #print(linecoords)
        mpnt = multipnt.newpoint(name='Point: {0},{1}'.format(prev_waypt[2],prev_waypt[3]))    #coords=[(waypt[1], waypt[2])])
        ...
        multipnt.newpoint(coords=[(prev__waypt[2], next_waypt[3])])
