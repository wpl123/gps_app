...
multilin.style.linestyle.color = simplekml.Color.black
multilin.style.linestyle.width = 5
multipoleven.style.polystyle.color = simplekml.Color.changealpha("77", simplekml.Color.orange)
multipoleven.style.linestyle.color = simplekml.Color.changealpha("77", simplekml.Color.orange)
multipolodd.style.polystyle.color = simplekml.Color.changealpha("77", simplekml.Color.lightblue)
multipolodd.style.linestyle.color = simplekml.Color.changealpha("77", simplekml.Color.lightblue)
