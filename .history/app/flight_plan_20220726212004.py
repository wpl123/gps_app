...
def write_kml(waypts):
    ...
    for waypt in waypts:
        ...
        lat_deg, lat_min, lat_sec, lat_ref = deg_to_dms(float(waypt[1]), 'latitude')
        print(lat_deg, lat_min, lat_sec)
        lon_deg, lon_min, lon_sec, lon_ref = deg_to_dms(float(waypt[2]), 'longitude')
        print(lon_deg, lon_min, lon_sec, lon_ref)
