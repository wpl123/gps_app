...
def write_kml(waypts):
    ...
    for waypt in waypts:
        ...
        if int(waypt[0]) % 2 == 1:                       # odd numbered strip
            linestring1 = kml.newlinestring(name=waypt[0])
            linestring1.coords = [(waypt[1],waypt[2]),(next_waypt[1],next_waypt[2])]
            linestring1.style.linestyle.width = 3
            linestring1.style.linestyle.color = simplekml.Color.blue 
            ...
            linestring2 = kml.newlinestring(name=waypt[0])
            linestring2.coords = [(next_waypt[1],next_waypt[2]),(waypt[1],waypt[2])] 
            linestring2.style.linestyle.width = 3
            linestring2.style.linestyle.color = simplekml.Color.blue
