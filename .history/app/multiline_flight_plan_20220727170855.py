...
def write_kml(waypts):
    ...
    for waypt in waypts:
        ...
        if int(waypt[0]) % 2 == 1:
            linecoords = [(waypt[2], waypt[3]), (next_waypt[4], next_waypt[5])]
            linecoords = [(waypt[1], waypt[2]), (next_waypt[1], next_waypt[2])]
        else:
            linecoords = [(waypt[1], waypt[2]), (next_waypt[1], next_waypt[2])]
            linecoords = [(waypt[1], waypt[2]), (next_waypt[1], next_waypt[2])]    
        #print(linecoords)
        mpnt = multipnt.newpoint(name='Point: {0},{1}'.format(waypt[1],waypt[2]))    #coords=[(waypt[1], waypt[2])])
        mpnt.coords = [(waypt[1],waypt[2])]
