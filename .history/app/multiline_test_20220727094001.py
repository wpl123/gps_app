...
multipolodd.style.polystyle.color = simplekml.Color.changealpha("77", Color.lightblue)
multipolodd.style.linestyle.color = simplekml.Color.changealpha("77", Color.lightblue)
