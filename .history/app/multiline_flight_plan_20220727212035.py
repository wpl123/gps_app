...
def write_kml(waypts):
    ...
    mln = multilin.style.linestyle.color = simplekml.Color.blue
    mln.multilin.style.linestyle.width = 2   
    ...
    for prev_waypt in waypts:
        ...
        #lo = lolabels.newpoint(name=str(prev_waypt[0]), coords=[(prev_waypt[1],next_waypt[2])])
