...
def write_kml(waypts):
    ...
    multilin = kml.newmultigeometry(name="Multi")
    ...
    for prev_waypt in waypts:
        ...
        next_waypt = next(iterators)
        linecoords = [](prev_waypt[2], prev_waypt[3]), (next_waypt[2], next_waypt[3]))
        ...
        #multipnt.newpoint(coords=[(next_waypt[2], next_waypt[3])])
