...
def write_kml(waypts):
    ...
    #multilin.style.linestyle.color = kml.Color.blue
    ...
    #    if i == 0:
    #        linecoords0 = [(prev_waypt[1], prev_waypt[2], prev_waypt[3]), (next_waypt[1], next_waypt[2], next_waypt[3])]
    #        print(linecoords0)
    #        multilin.newlinestring(coords=linecoords0)
